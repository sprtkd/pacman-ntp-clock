...
float utcOffset = 5.50; // Change utcOffset according to your utc
// =======================================================================
...
void loop()
{
    ...
    { // clock for 15s, then scrolls for about 30s
...
void getWeatherData()
{
    ...
    weatherString += "  Realfeel: " + String(tempRealFeel, 1) + deg;
    weatherString += "  Weather: " + weatherDescription;
